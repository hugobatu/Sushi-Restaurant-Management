...
router.post('/staff/ratings', manager_controllers.getBranchStaffRatings); // 6. xem đánh giá nvien của cnhanh manager đang qly
...
router.post('/branch-sales', manager_controllers.getBranchSales); // 7. xem doanh thu của chi nhánh mà manager đang quản lý
